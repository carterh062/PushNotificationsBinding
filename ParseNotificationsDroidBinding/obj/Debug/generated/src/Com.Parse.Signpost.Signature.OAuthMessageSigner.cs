...
namespace Com.Parse.Signpost.Signature {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='OAuthMessageSigner']"
	[global::Android.Runtime.Register ("com/parse/signpost/signature/OAuthMessageSigner", DoNotGenerateAcw=true)]
	public abstract partial class OAuthMessageSigner : global::Java.Lang.Object, global::Java.IO.ISerializable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/signpost/signature/OAuthMessageSigner", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='OAuthMessageSigner']/constructor[@name='OAuthMessageSigner' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public OAuthMessageSigner () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			global::Com.Parse.Signpost.Signature.OAuthMessageSigner __this = global::Java.Lang.Object.GetObject<global::Com.Parse.Signpost.Signature.OAuthMessageSigner> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual string ConsumerSecret {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='OAuthMessageSigner']/method[@name='getConsumerSecret' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='OAuthMessageSigner']/method[@name='setConsumerSecret' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public abstract string SignatureMethod {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='OAuthMessageSigner']/method[@name='getSignatureMethod' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string TokenSecret {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='OAuthMessageSigner']/method[@name='getTokenSecret' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='OAuthMessageSigner']/method[@name='setTokenSecret' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
			...
			set {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setTokenSecret_Ljava_lang_String_, new JValue (native_value));
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setTokenSecret", "(Ljava/lang/String;)V"), new JValue (native_value));
				JNIEnv.DeleteLocalRef (native_value);
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='OAuthMessageSigner']/method[@name='base64Encode' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register ("base64Encode", "([B)Ljava/lang/String;", "GetBase64Encode_arrayBHandler")]
		protected virtual string Base64Encode (byte[] p0)
		{
			...
			string __ret;
			if (GetType () == ThresholdType)
				__ret = JNIEnv.GetString (JNIEnv.CallObjectMethod  (Handle, id_base64Encode_arrayB, new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
			else
				__ret = JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "base64Encode", "([B)Ljava/lang/String;"), new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
			if (p0 != null) {
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='OAuthMessageSigner']/method[@name='decodeBase64' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("decodeBase64", "(Ljava/lang/String;)[B", "GetDecodeBase64_Ljava_lang_String_Handler")]
		protected virtual byte[] DecodeBase64 (string p0)
		{
			...
			byte[] __ret;
			if (GetType () == ThresholdType)
				__ret = (byte[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod  (Handle, id_decodeBase64_Ljava_lang_String_, new JValue (native_p0)), JniHandleOwnership.TransferLocalRef, typeof (byte));
			else
				__ret = (byte[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "decodeBase64", "(Ljava/lang/String;)[B"), new JValue (native_p0)), JniHandleOwnership.TransferLocalRef, typeof (byte));
			JNIEnv.DeleteLocalRef (native_p0);
			return __ret;
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='OAuthMessageSigner']/method[@name='sign' and count(parameter)=2 and parameter[1][@type='com.parse.signpost.http.HttpRequest'] and parameter[2][@type='com.parse.signpost.http.HttpParameters']]"
