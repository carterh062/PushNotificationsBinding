...
namespace Com.Parse.Codec.Binary {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.codec.binary']/class[@name='Base32InputStream']"
	[global::Android.Runtime.Register ("com/parse/codec/binary/Base32InputStream", DoNotGenerateAcw=true)]
	public partial class Base32InputStream : global::Com.Parse.Codec.Binary.BaseNCodecInputStream {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/codec/binary/Base32InputStream", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.codec.binary']/class[@name='Base32InputStream']/constructor[@name='Base32InputStream' and count(parameter)=1 and parameter[1][@type='java.io.InputStream']]"
		[Register (".ctor", "(Ljava/io/InputStream;)V", "")]
		public Base32InputStream (global::System.IO.Stream p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			IntPtr native_p0 = global::Android.Runtime.InputStreamAdapter.ToLocalJniHandle (p0);;
			if (GetType () != typeof (Base32InputStream)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.codec.binary']/class[@name='Base32InputStream']/constructor[@name='Base32InputStream' and count(parameter)=2 and parameter[1][@type='java.io.InputStream'] and parameter[2][@type='boolean']]"
		[Register (".ctor", "(Ljava/io/InputStream;Z)V", "")]
		public Base32InputStream (global::System.IO.Stream p0, bool p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.codec.binary']/class[@name='Base32InputStream']/constructor[@name='Base32InputStream' and count(parameter)=4 and parameter[1][@type='java.io.InputStream'] and parameter[2][@type='boolean'] and parameter[3][@type='int'] and parameter[4][@type='byte[]']]"
		[Register (".ctor", "(Ljava/io/InputStream;ZI[B)V", "")]
		public Base32InputStream (global::System.IO.Stream p0, bool p1, int p2, byte[] p3) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
