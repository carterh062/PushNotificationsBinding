...
namespace Com.Parse.Signpost.Signature {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='QueryStringSigningStrategy']"
	[global::Android.Runtime.Register ("com/parse/signpost/signature/QueryStringSigningStrategy", DoNotGenerateAcw=true)]
	public partial class QueryStringSigningStrategy : global::Java.Lang.Object, global::Com.Parse.Signpost.Signature.ISigningStrategy {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/signpost/signature/QueryStringSigningStrategy", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='QueryStringSigningStrategy']/constructor[@name='QueryStringSigningStrategy' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public QueryStringSigningStrategy () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			global::Com.Parse.Signpost.Signature.QueryStringSigningStrategy __this = global::Java.Lang.Object.GetObject<global::Com.Parse.Signpost.Signature.QueryStringSigningStrategy> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='QueryStringSigningStrategy']/method[@name='writeSignature' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='com.parse.signpost.http.HttpRequest'] and parameter[3][@type='com.parse.signpost.http.HttpParameters']]"
