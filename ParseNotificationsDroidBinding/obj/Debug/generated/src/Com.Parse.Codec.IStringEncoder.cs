...
namespace Com.Parse.Codec {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.parse.codec']/interface[@name='StringEncoder']"
	[Register ("com/parse/codec/StringEncoder", "", "Com.Parse.Codec.IStringEncoderInvoker")]
	public partial interface IStringEncoder : global::Com.Parse.Codec.IEncoder {

		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.codec']/interface[@name='StringEncoder']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("encode", "(Ljava/lang/String;)Ljava/lang/String;", "GetEncode_Ljava_lang_String_Handler:Com.Parse.Codec.IStringEncoderInvoker, ParseNotificationsDroidBinding")]
		string Encode (string p0);

	}

	[global::Android.Runtime.Register ("com/parse/codec/StringEncoder", DoNotGenerateAcw=true)]
	internal class IStringEncoderInvoker : global::Java.Lang.Object, IStringEncoder {

		static IntPtr java_class_ref = JNIEnv.FindClass ("com/parse/codec/StringEncoder");
		IntPtr class_ref;
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.parse.codec.StringEncoder"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Parse.Codec.IStringEncoder __this = global::Java.Lang.Object.GetObject<global::Com.Parse.Codec.IStringEncoder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
