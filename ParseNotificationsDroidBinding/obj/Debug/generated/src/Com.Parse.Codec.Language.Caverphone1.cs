...
namespace Com.Parse.Codec.Language {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.codec.language']/class[@name='Caverphone1']"
	[global::Android.Runtime.Register ("com/parse/codec/language/Caverphone1", DoNotGenerateAcw=true)]
	public partial class Caverphone1 : global::Com.Parse.Codec.Language.AbstractCaverphone {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/codec/language/Caverphone1", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.codec.language']/class[@name='Caverphone1']/constructor[@name='Caverphone1' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public Caverphone1 () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (Caverphone1)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Parse.Codec.Language.Caverphone1 __this = global::Java.Lang.Object.GetObject<global::Com.Parse.Codec.Language.Caverphone1> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.codec.language']/class[@name='Caverphone1']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
