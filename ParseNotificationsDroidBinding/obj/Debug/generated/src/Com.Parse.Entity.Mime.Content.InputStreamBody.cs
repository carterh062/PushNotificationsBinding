...
namespace Com.Parse.Entity.Mime.Content {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.entity.mime.content']/class[@name='InputStreamBody']"
	[global::Android.Runtime.Register ("com/parse/entity/mime/content/InputStreamBody", DoNotGenerateAcw=true)]
	public partial class InputStreamBody : global::Com.Parse.Entity.Mime.Content.AbstractContentBody {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/entity/mime/content/InputStreamBody", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (InputStreamBody); }
		}

		protected InputStreamBody (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_io_InputStream_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.entity.mime.content']/class[@name='InputStreamBody']/constructor[@name='InputStreamBody' and count(parameter)=2 and parameter[1][@type='java.io.InputStream'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/io/InputStream;Ljava/lang/String;)V", "")]
		public InputStreamBody (global::System.IO.Stream p0, string p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			if (GetType () != typeof (InputStreamBody)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Ljava/io/InputStream;Ljava/lang/String;)V", new JValue (native_p0), new JValue (native_p1)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Ljava/io/InputStream;Ljava/lang/String;)V", new JValue (native_p0), new JValue (native_p1));
				JNIEnv.DeleteLocalRef (native_p0);
				JNIEnv.DeleteLocalRef (native_p1);
				return;
			}

			if (id_ctor_Ljava_io_InputStream_Ljava_lang_String_ == IntPtr.Zero)
				id_ctor_Ljava_io_InputStream_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/io/InputStream;Ljava/lang/String;)V");
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_io_InputStream_Ljava_lang_String_, new JValue (native_p0), new JValue (native_p1)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Ljava_io_InputStream_Ljava_lang_String_, new JValue (native_p0), new JValue (native_p1));
			JNIEnv.DeleteLocalRef (native_p0);
			JNIEnv.DeleteLocalRef (native_p1);
		}

		static IntPtr id_ctor_Ljava_io_InputStream_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.entity.mime.content']/class[@name='InputStreamBody']/constructor[@name='InputStreamBody' and count(parameter)=3 and parameter[1][@type='java.io.InputStream'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)V", "")]
		public InputStreamBody (global::System.IO.Stream p0, string p1, string p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			if (GetType () != typeof (InputStreamBody)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)V", new JValue (native_p0), new JValue (native_p1), new JValue (native_p2)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)V", new JValue (native_p0), new JValue (native_p1), new JValue (native_p2));
				JNIEnv.DeleteLocalRef (native_p0);
				JNIEnv.DeleteLocalRef (native_p1);
			...
			if (id_ctor_Ljava_io_InputStream_Ljava_lang_String_Ljava_lang_String_ == IntPtr.Zero)
				id_ctor_Ljava_io_InputStream_Ljava_lang_String_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)V");
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_io_InputStream_Ljava_lang_String_Ljava_lang_String_, new JValue (native_p0), new JValue (native_p1), new JValue (native_p2)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Ljava_io_InputStream_Ljava_lang_String_Ljava_lang_String_, new JValue (native_p0), new JValue (native_p1), new JValue (native_p2));
			JNIEnv.DeleteLocalRef (native_p0);
			JNIEnv.DeleteLocalRef (native_p1);
			JNIEnv.DeleteLocalRef (native_p2);
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Parse.Entity.Mime.Content.InputStreamBody __this = global::Java.Lang.Object.GetObject<global::Com.Parse.Entity.Mime.Content.InputStreamBody> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override string Charset {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.entity.mime.content']/class[@name='InputStreamBody']/method[@name='getCharset' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override long ContentLength {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.entity.mime.content']/class[@name='InputStreamBody']/method[@name='getContentLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override string Filename {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.entity.mime.content']/class[@name='InputStreamBody']/method[@name='getFilename' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual global::System.IO.Stream InputStream {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.entity.mime.content']/class[@name='InputStreamBody']/method[@name='getInputStream' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override string TransferEncoding {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.entity.mime.content']/class[@name='InputStreamBody']/method[@name='getTransferEncoding' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.entity.mime.content']/class[@name='InputStreamBody']/method[@name='writeTo' and count(parameter)=1 and parameter[1][@type='java.io.OutputStream']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.entity.mime.content']/class[@name='InputStreamBody']/method[@name='writeTo' and count(parameter)=2 and parameter[1][@type='java.io.OutputStream'] and parameter[2][@type='int']]"
