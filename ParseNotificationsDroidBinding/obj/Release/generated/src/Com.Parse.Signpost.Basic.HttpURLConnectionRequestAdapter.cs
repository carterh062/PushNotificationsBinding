...
namespace Com.Parse.Signpost.Basic {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']"
	[global::Android.Runtime.Register ("com/parse/signpost/basic/HttpURLConnectionRequestAdapter", DoNotGenerateAcw=true)]
	public partial class HttpURLConnectionRequestAdapter : global::Java.Lang.Object, global::Com.Parse.Signpost.Http.IHttpRequest {


		static IntPtr connection_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/field[@name='connection']"
		[Register ("connection")]
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/signpost/basic/HttpURLConnectionRequestAdapter", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/constructor[@name='HttpURLConnectionRequestAdapter' and count(parameter)=1 and parameter[1][@type='java.net.HttpURLConnection']]"
		[Register (".ctor", "(Ljava/net/HttpURLConnection;)V", "")]
		public HttpURLConnectionRequestAdapter (global::Java.Net.HttpURLConnection p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			if (GetType () != typeof (HttpURLConnectionRequestAdapter)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Ljava/net/HttpURLConnection;)V", new JValue (p0)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Ljava/net/HttpURLConnection;)V", new JValue (p0));
				return;
			}
			...
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_net_HttpURLConnection_, new JValue (p0)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Ljava_net_HttpURLConnection_, new JValue (p0));
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Parse.Signpost.Basic.HttpURLConnectionRequestAdapter __this = global::Java.Lang.Object.GetObject<global::Com.Parse.Signpost.Basic.HttpURLConnectionRequestAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual global::System.Collections.Generic.IDictionary<string, string> AllHeaders {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getAllHeaders' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string ContentType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getContentType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual global::System.IO.Stream MessagePayload {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getMessagePayload' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Method {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getMethod' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string RequestUrl {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getRequestUrl' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='setRequestUrl' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setRequestUrl", "(Ljava/lang/String;)V"), new JValue (native_value));
				JNIEnv.DeleteLocalRef (native_value);
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getHeader' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		public virtual string GetHeader (string p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				__ret = JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getHeader", "(Ljava/lang/String;)Ljava/lang/String;"), new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='setHeader' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register ("setHeader", "(Ljava/lang/String;Ljava/lang/String;)V", "GetSetHeader_Ljava_lang_String_Ljava_lang_String_Handler")]
		public virtual void SetHeader (string p0, string p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setHeader", "(Ljava/lang/String;Ljava/lang/String;)V"), new JValue (native_p0), new JValue (native_p1));
			JNIEnv.DeleteLocalRef (native_p0);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='unwrap' and count(parameter)=0]"
		...
		public virtual global::Java.Lang.Object Unwrap ()
		{
			...
			if (GetType () == ThresholdType)
				...
				return global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "unwrap", "()Ljava/net/HttpURLConnection;")), JniHandleOwnership.TransferLocalRef);
		}
