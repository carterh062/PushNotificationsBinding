...
namespace Com.Parse.Gdata {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']"
	[global::Android.Runtime.Register ("com/parse/gdata/Preconditions", DoNotGenerateAcw=true)]
	public sealed partial class Preconditions : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/gdata/Preconditions", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkArgument' and count(parameter)=1 and parameter[1][@type='boolean']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkArgument' and count(parameter)=2 and parameter[1][@type='boolean'] and parameter[2][@type='java.lang.Object']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkArgument' and count(parameter)=3 and parameter[1][@type='boolean'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.Object...']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkElementIndex' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register ("checkElementIndex", "(II)V", "")]
		public static void CheckElementIndex (int p0, int p1)
		{
			if (id_checkElementIndex_II == IntPtr.Zero)
				id_checkElementIndex_II = JNIEnv.GetStaticMethodID (class_ref, "checkElementIndex", "(II)V");
			JNIEnv.CallStaticVoidMethod  (class_ref, id_checkElementIndex_II, new JValue (p0), new JValue (p1));
		}

		static IntPtr id_checkElementIndex_IILjava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkElementIndex' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String']]"
		[Register ("checkElementIndex", "(IILjava/lang/String;)V", "")]
		public static void CheckElementIndex (int p0, int p1, string p2)
		{
			...
			JNIEnv.CallStaticVoidMethod  (class_ref, id_checkElementIndex_IILjava_lang_String_, new JValue (p0), new JValue (p1), new JValue (native_p2));
			JNIEnv.DeleteLocalRef (native_p2);
		}

		static IntPtr id_checkNotNull_Ljava_lang_Object_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkNotNull' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkNotNull' and count(parameter)=2 and parameter[1][@type='java.lang.Object'] and parameter[2][@type='java.lang.Object']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkNotNull' and count(parameter)=3 and parameter[1][@type='java.lang.Object'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.Object...']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkPositionIndex' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register ("checkPositionIndex", "(II)V", "")]
		public static void CheckPositionIndex (int p0, int p1)
		{
			...
			JNIEnv.CallStaticVoidMethod  (class_ref, id_checkPositionIndex_II, new JValue (p0), new JValue (p1));
		}

		static IntPtr id_checkPositionIndex_IILjava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkPositionIndex' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String']]"
		[Register ("checkPositionIndex", "(IILjava/lang/String;)V", "")]
		public static void CheckPositionIndex (int p0, int p1, string p2)
		{
			...
			IntPtr native_p2 = JNIEnv.NewString (p2);
			JNIEnv.CallStaticVoidMethod  (class_ref, id_checkPositionIndex_IILjava_lang_String_, new JValue (p0), new JValue (p1), new JValue (native_p2));
			JNIEnv.DeleteLocalRef (native_p2);
		}

		static IntPtr id_checkPositionIndexes_III;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkPositionIndexes' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkState' and count(parameter)=1 and parameter[1][@type='boolean']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkState' and count(parameter)=2 and parameter[1][@type='boolean'] and parameter[2][@type='java.lang.Object']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='Preconditions']/method[@name='checkState' and count(parameter)=3 and parameter[1][@type='boolean'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.Object...']]"
