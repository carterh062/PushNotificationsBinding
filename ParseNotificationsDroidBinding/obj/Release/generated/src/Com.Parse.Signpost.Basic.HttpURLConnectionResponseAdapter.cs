...
namespace Com.Parse.Signpost.Basic {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionResponseAdapter']"
	[global::Android.Runtime.Register ("com/parse/signpost/basic/HttpURLConnectionResponseAdapter", DoNotGenerateAcw=true)]
	public partial class HttpURLConnectionResponseAdapter : global::Java.Lang.Object, global::Com.Parse.Signpost.Http.IHttpResponse {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/signpost/basic/HttpURLConnectionResponseAdapter", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionResponseAdapter']/constructor[@name='HttpURLConnectionResponseAdapter' and count(parameter)=1 and parameter[1][@type='java.net.HttpURLConnection']]"
		[Register (".ctor", "(Ljava/net/HttpURLConnection;)V", "")]
		public HttpURLConnectionResponseAdapter (global::Java.Net.HttpURLConnection p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			global::Com.Parse.Signpost.Basic.HttpURLConnectionResponseAdapter __this = global::Java.Lang.Object.GetObject<global::Com.Parse.Signpost.Basic.HttpURLConnectionResponseAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual global::System.IO.Stream Content {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionResponseAdapter']/method[@name='getContent' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string ReasonPhrase {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionResponseAdapter']/method[@name='getReasonPhrase' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual int StatusCode {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionResponseAdapter']/method[@name='getStatusCode' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.basic']/class[@name='HttpURLConnectionResponseAdapter']/method[@name='unwrap' and count(parameter)=0]"
