...
namespace Com.Parse.Gdata {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.gdata']/class[@name='UnicodeEscaper']"
	[global::Android.Runtime.Register ("com/parse/gdata/UnicodeEscaper", DoNotGenerateAcw=true)]
	public abstract partial class UnicodeEscaper : global::Java.Lang.Object, global::Com.Parse.Gdata.IEscaper {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/gdata/UnicodeEscaper", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.gdata']/class[@name='UnicodeEscaper']/constructor[@name='UnicodeEscaper' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public UnicodeEscaper () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='UnicodeEscaper']/method[@name='codePointAt' and count(parameter)=3 and parameter[1][@type='java.lang.CharSequence'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		[Register ("codePointAt", "(Ljava/lang/CharSequence;II)I", "")]
		protected static int CodePointAt (global::Java.Lang.ICharSequence p0, int p1, int p2)
		{
			...
			int __ret = JNIEnv.CallStaticIntMethod  (class_ref, id_codePointAt_Ljava_lang_CharSequence_II, new JValue (native_p0), new JValue (p1), new JValue (p2));
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='UnicodeEscaper']/method[@name='escape' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='UnicodeEscaper']/method[@name='escape' and count(parameter)=1 and parameter[1][@type='java.lang.Appendable']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='UnicodeEscaper']/method[@name='escape' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("escape", "(Ljava/lang/String;)Ljava/lang/String;", "GetEscape_Ljava_lang_String_Handler")]
		public virtual string Escape (string p0)
		{
			...
			string __ret;
			if (GetType () == ThresholdType)
				__ret = JNIEnv.GetString (JNIEnv.CallObjectMethod  (Handle, id_escape_Ljava_lang_String_, new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
			else
				__ret = JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "escape", "(Ljava/lang/String;)Ljava/lang/String;"), new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
			JNIEnv.DeleteLocalRef (native_p0);
			return __ret;
		}

		static IntPtr id_escapeSlow_Ljava_lang_String_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='UnicodeEscaper']/method[@name='escapeSlow' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int']]"
		[Register ("escapeSlow", "(Ljava/lang/String;I)Ljava/lang/String;", "")]
		protected string EscapeSlow (string p0, int p1)
		{
			...
			IntPtr native_p0 = JNIEnv.NewString (p0);
			string __ret = JNIEnv.GetString (JNIEnv.CallObjectMethod  (Handle, id_escapeSlow_Ljava_lang_String_I, new JValue (native_p0), new JValue (p1)), JniHandleOwnership.TransferLocalRef);
			JNIEnv.DeleteLocalRef (native_p0);
			return __ret;
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.gdata']/class[@name='UnicodeEscaper']/method[@name='nextEscapeIndex' and count(parameter)=3 and parameter[1][@type='java.lang.CharSequence'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
