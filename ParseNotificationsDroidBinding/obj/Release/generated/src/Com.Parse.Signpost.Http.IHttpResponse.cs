...
namespace Com.Parse.Signpost.Http {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.parse.signpost.http']/interface[@name='HttpResponse']"
	[Register ("com/parse/signpost/http/HttpResponse", "", "Com.Parse.Signpost.Http.IHttpResponseInvoker")]
	public partial interface IHttpResponse : IJavaObject {

		global::System.IO.Stream Content {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.http']/interface[@name='HttpResponse']/method[@name='getContent' and count(parameter)=0]"
			[Register ("getContent", "()Ljava/io/InputStream;", "GetGetContentHandler:Com.Parse.Signpost.Http.IHttpResponseInvoker, ParseNotificationsDroidBinding")] get;
		}

		string ReasonPhrase {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.http']/interface[@name='HttpResponse']/method[@name='getReasonPhrase' and count(parameter)=0]"
			[Register ("getReasonPhrase", "()Ljava/lang/String;", "GetGetReasonPhraseHandler:Com.Parse.Signpost.Http.IHttpResponseInvoker, ParseNotificationsDroidBinding")] get;
		}

		int StatusCode {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.http']/interface[@name='HttpResponse']/method[@name='getStatusCode' and count(parameter)=0]"
			[Register ("getStatusCode", "()I", "GetGetStatusCodeHandler:Com.Parse.Signpost.Http.IHttpResponseInvoker, ParseNotificationsDroidBinding")] get;
		}

		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.http']/interface[@name='HttpResponse']/method[@name='unwrap' and count(parameter)=0]"
		[Register ("unwrap", "()Ljava/lang/Object;", "GetUnwrapHandler:Com.Parse.Signpost.Http.IHttpResponseInvoker, ParseNotificationsDroidBinding")]
		global::Java.Lang.Object Unwrap ();

	}

	[global::Android.Runtime.Register ("com/parse/signpost/http/HttpResponse", DoNotGenerateAcw=true)]
	internal class IHttpResponseInvoker : global::Java.Lang.Object, IHttpResponse {

		static IntPtr java_class_ref = JNIEnv.FindClass ("com/parse/signpost/http/HttpResponse");
		IntPtr class_ref;
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.parse.signpost.http.HttpResponse"));
			return handle;
		}
