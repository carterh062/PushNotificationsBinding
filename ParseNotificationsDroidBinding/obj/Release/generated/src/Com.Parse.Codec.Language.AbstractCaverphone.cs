...
namespace Com.Parse.Codec.Language {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.codec.language']/class[@name='AbstractCaverphone']"
	[global::Android.Runtime.Register ("com/parse/codec/language/AbstractCaverphone", DoNotGenerateAcw=true)]
	public abstract partial class AbstractCaverphone : global::Java.Lang.Object, global::Com.Parse.Codec.IStringEncoder {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/codec/language/AbstractCaverphone", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.codec.language']/class[@name='AbstractCaverphone']/constructor[@name='AbstractCaverphone' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public AbstractCaverphone () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (AbstractCaverphone)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Parse.Codec.Language.AbstractCaverphone __this = global::Java.Lang.Object.GetObject<global::Com.Parse.Codec.Language.AbstractCaverphone> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.codec.language']/class[@name='AbstractCaverphone']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.codec.language']/class[@name='AbstractCaverphone']/method[@name='isEncodeEqual' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.codec.language']/class[@name='AbstractCaverphone']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
	...
	internal partial class AbstractCaverphoneInvoker : AbstractCaverphone {
		...
		public override string Encode (string p0)
		{
			...
			IntPtr native_p0 = JNIEnv.NewString (p0);
			string __ret = JNIEnv.GetString (JNIEnv.CallObjectMethod  (Handle, id_encode_Ljava_lang_String_, new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
			JNIEnv.DeleteLocalRef (native_p0);
			return __ret;
		}
