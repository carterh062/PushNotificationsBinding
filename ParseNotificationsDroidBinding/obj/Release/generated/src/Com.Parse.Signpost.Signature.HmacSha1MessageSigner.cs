...
namespace Com.Parse.Signpost.Signature {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='HmacSha1MessageSigner']"
	[global::Android.Runtime.Register ("com/parse/signpost/signature/HmacSha1MessageSigner", DoNotGenerateAcw=true)]
	public partial class HmacSha1MessageSigner : global::Com.Parse.Signpost.Signature.OAuthMessageSigner {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/signpost/signature/HmacSha1MessageSigner", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='HmacSha1MessageSigner']/constructor[@name='HmacSha1MessageSigner' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public HmacSha1MessageSigner () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			global::Com.Parse.Signpost.Signature.HmacSha1MessageSigner __this = global::Java.Lang.Object.GetObject<global::Com.Parse.Signpost.Signature.HmacSha1MessageSigner> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override string SignatureMethod {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='HmacSha1MessageSigner']/method[@name='getSignatureMethod' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse.signpost.signature']/class[@name='HmacSha1MessageSigner']/method[@name='sign' and count(parameter)=2 and parameter[1][@type='com.parse.signpost.http.HttpRequest'] and parameter[2][@type='com.parse.signpost.http.HttpParameters']]"
