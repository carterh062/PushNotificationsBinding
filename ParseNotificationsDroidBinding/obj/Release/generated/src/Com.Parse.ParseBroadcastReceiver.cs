...
namespace Com.Parse {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse']/class[@name='ParseBroadcastReceiver']"
	[global::Android.Runtime.Register ("com/parse/ParseBroadcastReceiver", DoNotGenerateAcw=true)]
	public partial class ParseBroadcastReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/ParseBroadcastReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ParseBroadcastReceiver); }
		}

		protected ParseBroadcastReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse']/class[@name='ParseBroadcastReceiver']/constructor[@name='ParseBroadcastReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public ParseBroadcastReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (ParseBroadcastReceiver)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Parse.ParseBroadcastReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Parse.ParseBroadcastReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.parse']/class[@name='ParseBroadcastReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
