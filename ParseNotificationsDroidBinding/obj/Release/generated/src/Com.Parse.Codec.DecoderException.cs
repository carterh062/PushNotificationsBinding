...
namespace Com.Parse.Codec {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.parse.codec']/class[@name='DecoderException']"
	[global::Android.Runtime.Register ("com/parse/codec/DecoderException", DoNotGenerateAcw=true)]
	public partial class DecoderException : global::Java.Lang.Exception {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/parse/codec/DecoderException", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.codec']/class[@name='DecoderException']/constructor[@name='DecoderException' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public DecoderException () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.codec']/class[@name='DecoderException']/constructor[@name='DecoderException' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public DecoderException (string p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.codec']/class[@name='DecoderException']/constructor[@name='DecoderException' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/Throwable;)V", "")]
		public DecoderException (string p0, global::Java.Lang.Throwable p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.parse.codec']/class[@name='DecoderException']/constructor[@name='DecoderException' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/Throwable;)V", "")]
		public DecoderException (global::Java.Lang.Throwable p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
